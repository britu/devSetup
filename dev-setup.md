...
# Composer install
```
https://www.youtube.com/watch?v=3qRled3LbHk&ab_channel=JaviMata-WebDeveloper
Composer --> Documentation --> Click download link
- make a directory stay in directory:
```
```
in Command line one line copy paste enter 
